...
//             // Write header - exclude text column as requested
...
//                 // Add newline after each record - this was missing in the original code
//                 file << std::endl;
//             }
...
//                 std::string display_text = record.text;
//                 if (display_text.length() > 27)
//                 {
//                     display_text = display_text.substr(0, 24) + "...";
//                 }
//                 std::cout << std::setw(30) << display_text;
//             }
...
//     std::unique_ptr<Dataset> load_and_preprocess(const std::string &filename, bool include_text)
//     {
//         // Create a new Dataset instance
//         auto dataset = std::make_unique<Dataset>(include_text);
